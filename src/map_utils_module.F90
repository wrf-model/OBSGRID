...
IMPLICIT NONE
  ...
  REAL, PRIVATE, PARAMETER    :: pi = 3.14159265358
...
! REAL, PUBLIC , PARAMETER    :: earth_radius_m = 6371200. !  Brent
  REAL, PUBLIC , PARAMETER    :: earth_radius_m = 6370000. !  consistent with rest of MM5 system
